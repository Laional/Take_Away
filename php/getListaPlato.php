...
if ($_SERVER['REQUEST_METHOD'] === 'GET'){
    ...
    $sql = "SELECT tp.Nombre_plato, tp.Precio_plato, tp.Descripcion_plato, tp.Foto_plato, tp.Disponible_plato, tc.Nombre_categoria FROM t_platos tp, t_categorias tc WHERE tp.ID_categoria_plato = tc.ID_categoria";
